...
#-------------------------------------------------------------------------------------------------AJAX Fetch Page PART---------------------------------------
        ...
        if str_url.startswith("!"): # handle ajax request to get all data for modal popup window
            ...
            wif_U = ice.btc_pvk_to_wif(hex(numb)[2:], False)
            wif_C = ice.btc_pvk_to_wif(hex(numb)[2:])
            pub = ice.scalar_multiplication(numb)
            P = pub.hex() #getting point coordinates
            P_sha256 = sha256(P)
            P_X = P[2:66]
            P_Y = P[66:]
            pubkey_compressed = ice.point_to_cpub(pub)
            ...
            rmdU_pref = '00' + ice.privatekey_to_h160(0, False, numb).hex()  #Uncompressed RIPEMD160 prefix
            rmdC_pref = '00' + ice.privatekey_to_h160(0, True, numb).hex()  #Compressed RIPEMD160 prefix
            ######
            ...
            ######
            addrU_one = ice.pubkey_to_address(0, False, pub)
            addrC_one = ice.pubkey_to_address(0, True, pub)
            addrP2sh_one = ice.pubkey_to_address(1, True, pub) #p2sh
            addrbech32_one = ice.pubkey_to_address(2, True, pub) #bech32
            addrbech32_p2wsh = bitcoinlib.keys.Address(ice.point_to_cpub(pub),encoding='bech32',script_type='p2wsh').address #bech32_p2swh
            ...
            b_word1 = "No"
            if ice.check_in_bloom(addrU_one, __class__._bits, __class__._hashes, __class__._bf):
                b_word1 = "Yes"
                with open("found.txt", "a", encoding="utf-8") as f:
                    f.write(f"Address: {addrU_one} Private Key: {hex(numb)[2:].zfill(64)}\n")
            if ice.check_in_bloom(addrC_one, __class__._bits, __class__._hashes, __class__._bf):
                b_word1 = "Yes"
                with open("found.txt", "a", encoding="utf-8") as f:
                    f.write(f"Address: {addrC_one} Private Key: {hex(numb)[2:].zfill(64)}\n")

            b_word12 = "No"
            if ice.check_in_bloom(addrP2sh_one, __class__._bits, __class__._hashes, __class__._bf):
                b_word12 = "Yes"
                with open("found.txt", "a", encoding="utf-8") as f:
                    f.write(f"Address: {addrP2sh_one} Private Key: {hex(numb)[2:].zfill(64)}\n")
            if ice.check_in_bloom(addrbech32_one, __class__._bits, __class__._hashes, __class__._bf):
                b_word12 = "Yes"
                with open("found.txt", "a", encoding="utf-8") as f:
                    f.write(f"Address: {addrbech32_one} Private Key: {hex(numb)[2:].zfill(64)}\n")

            b_word13 = "No"
            if ice.check_in_bloom(addrbech32_p2wsh, __class__._bits, __class__._hashes, __class__._bf):
                b_word13 = "Yes"
                with open("found.txt", "a", encoding="utf-8") as f:
                    f.write(f"Address: {addrbech32_p2wsh} Private Key: {hex(numb)[2:].zfill(64)}\n")

            b_word14 = "No"
            if ice.check_in_bloom(bech32m_taproot_addr, __class__._bits, __class__._hashes, __class__._bf):
                b_word14 = "Yes"
                with open("found.txt", "a", encoding="utf-8") as f:
            ...
            AP_pub = ice.scalar_multiplication(add_inv)
            AP = AP_pub.hex()
            AP_X = AP[2:66]
            AP_Y = AP[66:]
            addrU = ice.pubkey_to_address(0, False, AP_pub)
            addrC = ice.pubkey_to_address(0, True, AP_pub)
            addrP2sh_inv = ice.pubkey_to_address(1, True, AP_pub) #p2sh
            addrbech32_inv = ice.pubkey_to_address(2, True, AP_pub) #bech32

            b_word = "No"
            if ice.check_in_bloom(addrU, __class__._bits, __class__._hashes, __class__._bf):
                b_word = "Yes"
                with open("found.txt", "a", encoding="utf-8") as f:
                    f.write(f"Address: {addrU} Private Key: {hex(add_inv)[2:].zfill(64)}\n")
            if ice.check_in_bloom(addrC, __class__._bits, __class__._hashes, __class__._bf):
                b_word = "Yes"
                with open("found.txt", "a", encoding="utf-8") as f:
                    f.write(f"Address: {addrC} Private Key: {hex(add_inv)[2:].zfill(64)}\n")

            b_word_pb_inv = "No"
            if ice.check_in_bloom(addrP2sh_inv, __class__._bits, __class__._hashes, __class__._bf):
                b_word_pb_inv = "Yes"
                with open("found.txt", "a", encoding="utf-8") as f:
                    f.write(f"Address: {addrP2sh_inv} Private Key: {hex(add_inv)[2:].zfill(64)}\n")
            if ice.check_in_bloom(addrbech32_inv, __class__._bits, __class__._hashes, __class__._bf):
                b_word_pb_inv = "Yes"
                with open("found.txt", "a", encoding="utf-8") as f:
            ...
            sameaddr1U = ice.pubkey_to_address(0, False, samey1P)
            sameaddr1C = ice.pubkey_to_address(0, True, samey1P)
            addrP2sh_same1 = ice.pubkey_to_address(1, True, samey1P) #p2sh
            addrbech32_same1 = ice.pubkey_to_address(2, True, samey1P) #bech32

            b_word_same1 = "No"
            if ice.check_in_bloom(sameaddr1U, __class__._bits, __class__._hashes, __class__._bf):
                b_word_same1 = "Yes"
                with open("found.txt", "a", encoding="utf-8") as f:
                    f.write(f"Address: {sameaddr1U} Private Key: {hex(same1n)[2:].zfill(64)}\n")
            if ice.check_in_bloom(sameaddr1C, __class__._bits, __class__._hashes, __class__._bf):
                b_word_same1 = "Yes"
                with open("found.txt", "a", encoding="utf-8") as f:
                    f.write(f"Address: {sameaddr1C} Private Key: {hex(same1n)[2:].zfill(64)}\n")

            b_word_same1pb = "No"
            if ice.check_in_bloom(addrP2sh_same1, __class__._bits, __class__._hashes, __class__._bf):
                b_word_same1pb = "Yes"
                with open("found.txt", "a", encoding="utf-8") as f:
                    f.write(f"Address: {addrP2sh_same1} Private Key: {hex(same1n)[2:].zfill(64)}\n")
            if ice.check_in_bloom(addrbech32_same1, __class__._bits, __class__._hashes, __class__._bf):
                b_word_same1pb = "Yes"
                with open("found.txt", "a", encoding="utf-8") as f:
                    f.write(f"Address: {addrbech32_same1} Private Key: {hex(same1n)[2:].zfill(64)}\n")

            samey2P = ice.scalar_multiplication(same2n)
            sameaddr2U = ice.pubkey_to_address(0, False, samey2P)
            sameaddr2C = ice.pubkey_to_address(0, True, samey2P)
            addrP2sh_same2 = ice.pubkey_to_address(1, True, samey2P) #p2sh
            addrbech32_same2 = ice.pubkey_to_address(2, True, samey2P) #bech32

            b_word_same2 = "No"
            if ice.check_in_bloom(sameaddr2U, __class__._bits, __class__._hashes, __class__._bf):
                b_word_same2 = "Yes"
                with open("found.txt", "a", encoding="utf-8") as f:
                    f.write(f"Address: {sameaddr2U} Private Key: {hex(same2n)[2:].zfill(64)}\n")
            if ice.check_in_bloom(sameaddr2C, __class__._bits, __class__._hashes, __class__._bf):
                b_word_same2 = "Yes"
                with open("found.txt", "a", encoding="utf-8") as f:
                    f.write(f"Address: {sameaddr2C} Private Key: {hex(same2n)[2:].zfill(64)}\n")

            b_word_same2pb = "No"
            if ice.check_in_bloom(addrP2sh_same2, __class__._bits, __class__._hashes, __class__._bf):
                b_word_same2pb = "Yes"
                with open("found.txt", "a", encoding="utf-8") as f:
                    f.write(f"Address: {addrP2sh_same2} Private Key: {hex(same2n)[2:].zfill(64)}\n")
            if ice.check_in_bloom(addrbech32_same2, __class__._bits, __class__._hashes, __class__._bf):
                b_word_same2pb = "Yes"
                with open("found.txt", "a", encoding="utf-8") as f:
            ...
            +rmdU_pref_sha256_2+" "+rmdC_pref_sha256_2, "utf-8"))
...
<h4 style='color:brown;font-weight:bold;'>Endomorphism</h4>
...
<p id='same2addrpb' style='color:blue;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;'></p>
            ...
            ###---Loop---******************************************************************
            pub = ice.scalar_multiplication((__class__.startPrivKey*Point_Coefficient)%N)
            for i in range(128): #generating addresses and WIFS to show on page
                __class__.starting_key_hex = hex((__class__.startPrivKey*Point_Coefficient)%N)[2:].zfill(64)
                __class__.privKey_C = ice.btc_pvk_to_wif(__class__.starting_key_hex)
                __class__.privKey = ice.btc_pvk_to_wif(__class__.starting_key_hex, False)
                __class__.bitAddr = ice.pubkey_to_address(0, False, pub)
                __class__.bitAddr_C = ice.pubkey_to_address(0, True, pub)
                addrP2sh = ice.pubkey_to_address(1, True, pub) #p2sh
                addrbech32 = ice.pubkey_to_address(2, True, pub) #bech32
                addrbech32_p2wsh = bitcoinlib.keys.Address(ice.point_to_cpub(pub),encoding='bech32',script_type='p2wsh').address #bech32_p2swh
                public_key_x_coordinate = pub[1:33]
                taproot_tweaked_public_key = p2tr_util.public_key_x_coordinate_to_taproot_tweaked_pubkey(public_key_x_coordinate)
                bech32m_taproot_addr = p2tr_util.pubkey_to_segwit_v1_addr('bc', taproot_tweaked_public_key)

                if ice.check_in_bloom(__class__.bitAddr, __class__._bits, __class__._hashes, __class__._bf):
                ...
                if ice.check_in_bloom(__class__.bitAddr_C, __class__._bits, __class__._hashes, __class__._bf):
                    __class__.balance_on_page = "True"
                ...
                if ice.check_in_bloom(addrP2sh, __class__._bits, __class__._hashes, __class__._bf):
                    __class__.balance_on_page = "True"
                ...
                if ice.check_in_bloom(addrbech32, __class__._bits, __class__._hashes, __class__._bf):
                    __class__.balance_on_page = "True"
                ...
                if ice.check_in_bloom(bech32m_taproot_addr, __class__._bits, __class__._hashes, __class__._bf):
                    ...
                    with open("found.txt", "a", encoding="utf-8") as f:
                        f.write(f"Address: {bech32m_taproot_addr} Page: {__class__.num} Private Key: {__class__.starting_key_hex} \n")
